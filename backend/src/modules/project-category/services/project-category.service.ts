...
} from '../dto/create-project-category.dto';

import {
  UpdateProjectCategoryDto,
} from '../dto/update-project-category.dto';
...
export class ProjectCategoryService {
  ...
  async create(
    ...
    const existingName =
      await this.projectCategoryRepository.findByName(
        companyId,
        name,
      );
    ...
    const existingCode =
      await this.projectCategoryRepository.findByCode(
        companyId,
        code,
      );
    ...
    if (existingCode) {
      throw new ConflictException(
        'Project category code already exists.',
      );
    }
  ...
  async findAll(
    ...
    const categories =
      await this.projectCategoryRepository.findAll(
        companyId,
      );
  ...
  async update(
    ...
    const updated =
      await this.projectCategoryRepository.update(
        companyId,
        uuid,
        {
          ...(name !== undefined && {
  ...
  async delete(
    ...
    const projectCount =
      await this.projectCategoryRepository.countProjects(
        companyId,
        category.id,
      );
    ...
    await this.projectCategoryRepository.softDelete(
      companyId,
      uuid,
    );
